...
class DashboardTests(unittest.TestCase):
    ...
    def test_public_proof_payload_and_html_include_case_studies(self):
        ...
        self.assertNotIn("repositories", payload["metrics"])
        self.assertNotIn("case_studies", payload["metrics"])
        self.assertNotIn("novyx", payload["metrics"])
        self.assertNotIn("side_effects", payload["metrics"])
